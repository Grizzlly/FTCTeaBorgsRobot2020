...
@Autonomous(name= "Tava_Rosu_BUNA", group="Tavab")
//@Disabled//comment out this line before using
public class Tava_Rosu extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if (opModeIsActive()) {
            ...
            ///FACUT DIN OCHI <3
            driveFrontStraight_Lift(4000, 2500, 4000, 4000, 0, 0.9, 1);
            resetDrives();

            driveFrontStraight(4000, 700, 4000, 4000, 0, 0.5, 1);
            resetDrives();
            ...
            driveBackStraight(8000, 4700, 8000, 8000, -90, 0.9, 1);
            resetDrives();
            runtime.reset();

            angles = gyro.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);
            RotateRight(angles.firstAngle, 0.8, -90);

            driveFrontStraight(4000, 1426, 4000, 4000, -90, 0.5, 1);
            resetDrives();
            ...
            driveRightStraight(4000, 1000, 4000, 4000, -80, 0.7, 1);
            resetDrives();

            driveBackStraight_Lift(4000, 3200, 4000, 4000, -82, 0.9, 1);
            resetDrives();
        }
    }
    ...
    public void driveBackStraight_Lift(int t1, int t2, int t3, int t4, double straightAngle, double speed, double P)
    {
        ...
        while(Math.abs(frontRight.getCurrentPosition()) < t2-200)
        {
            ...
            backLeft.setPower(powerBL);
            backRight.setPower(powerBR);
            if(motorLift1.getCurrentPosition()>motorLift1.getTargetPosition()+20)
            {
                motorLift1.setPower(-1);
                motorLift2.setPower(-1);
            }
    ...
    public void driveFrontStraight_Lift(int t1, int t2, int t3, int t4, double straightAngle, double speed, int P)
    {
        ...
        Orientation unghi = gyro.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);

        while(Math.abs(frontRight.getCurrentPosition()) < t2-200)
        {
            motorLift1.setTargetPosition(600);

            unghi = gyro.getAngularOrientation(AxesReference.INTRINSIC, AxesOrder.ZYX, AngleUnit.DEGREES);

            double error = unghi.firstAngle;
