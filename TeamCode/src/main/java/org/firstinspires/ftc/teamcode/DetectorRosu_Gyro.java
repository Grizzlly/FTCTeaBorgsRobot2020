 ...
 *YES
 */
@Autonomous(name= "DetectorRosu_Gyro", group="Sky autonomous")
       ...
       // while (opModeIsActive()){
            ...
            switch(chosen)
            {
                case 1:
                    ...
                    driveLeftStraight(750, 750, 750, 750, 0, 0.4);
                    resetDrives();
                    runtime.reset();
                    //while(runtime.seconds()<0.5){}
                    ...
                    driveBackStraight(1464, 1732, 1867, 1743, 0, 0.5);
                    resetDrives();
                    runtime.reset();
                    //while(runtime.seconds()<0.5){}

                    driveRightStraight(5023, 5047, 5046, 5002, 0, 0.5);
                    resetDrives();
                    runtime.reset();
                    //while(runtime.seconds()<0.5){}
                    ...
                    driveLeftStraight(3903, 3903, 3903, 3903, 0, 0.5);
                    runtime.reset();
                    //while(runtime.seconds()<0.5){}
                    resetDrives();
                    ...
                    driveRightStraight(3800, 3800, 3800, 3800, 0, 0.5);
                    resetDrives();
                    runtime.reset();
                    //while(runtime.seconds()<0.5){}
                ...
                case 2:
                    ...
                    driveRightStraight(300, 300, 300, 300, 0, 0.4);
                    resetDrives();
                    runtime.reset();
                    //while(runtime.seconds()<0.5){}
                    ...
                    driveRightStraight(4523, 4747, 4346, 4302, 0, 0.5);
                    resetDrives();
                    runtime.reset();
                    //while(runtime.seconds()<0.5){}
                    ...
                    driveLeftStraight(6813, 6813, 6813, 6813, 0, 0.5);
                    runtime.reset();
                    //while(runtime.seconds()<0.5){}
                    resetDrives();
                    ...
                    driveRightStraight(6500, 6500, 6500, 6500, 0, 0.5);
                    resetDrives();
                    runtime.reset();
                    //while(runtime.seconds()<0.5){}
                ...
                case 3:
                    ...
                    driveRightStraight(900, 1100, 1100, 1100, 0, 0.4);
                    resetDrives();
                    runtime.reset();
                    //while(runtime.seconds()<0.5){}
                    ...
                    driveRightStraight(3523, 3747, 3346, 3302, 0, 0.5);
                    resetDrives();
                    runtime.reset();
                    //while(runtime.seconds()<0.5){}
                    ...
                    driveLeftStraight(5913, 5913, 5913, 5913, 0, 0.5);
                    runtime.reset();
                    //while(runtime.seconds()<0.5){}
                    resetDrives();
