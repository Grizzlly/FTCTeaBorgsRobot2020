    ...
    */
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            driveRightStraight(3500, 3500, 3500, 3500, 0, 0.4);
            runtime.reset();
            while(runtime.seconds()<0.5){}
            resetDrives();

            driveBackStraight(1300, 1300, 1300, 1300, 0, 0.4);
            runtime.reset();
            while(runtime.seconds()<0.5){}
            resetDrives();

            RotateRight(0, 0.4, -90);
            resetDrives();

            driveLeftStraight(2000, 2000, 2000, 2000, -90, 0.3);
            runtime.reset();
            while(runtime.seconds()<0.5){}
            resetDrives();
            ...
            driveFrontStraight(2000, 2000, 2000, 2000, -90, 0.4);
            runtime.reset();
            while(runtime.seconds()<0.5){}
            resetDrives();
